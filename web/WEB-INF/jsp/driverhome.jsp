...
<div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          <p><a href="./rides" type="button" class="btn btn-success">Viajes disponibles</a></p>
          <p><a href="./driverongoingride" type="button" class="btn btn-success">Viaje en proceso</a></p>
          <p><a href="./driverhistoric" type="button" class="btn btn-success">Viajes terminados</a></p>
